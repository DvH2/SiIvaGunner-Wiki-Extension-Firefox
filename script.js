if (window.location.href.indexOf("www.youtube.com/watch?v=") > -1) {
  ...
  var url = "https://siivagunner.wiki/wiki/" + wikiEncoding(ripTitle);

  if (channel == "SiIvaGunner" || channel == "SiIvaGunner Wiki") {
    window.open(url);
  }
}
  ...
  var url = "https://siivagunner.wiki/wiki/Category:" + wikiEncoding(playlistTitle);
